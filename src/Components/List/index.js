...
export class ListVC extends React.Component {
  ...
  LoadData() {
    Realm.open({schema: [parkingLot]}).then(realm => {
      ...
      fetch(
        'https://cloud.mongodb.com/api/atlas/v1.0/groups/60e305202ae0b86829857edc/clusters/Cluster0',
        {
          method: 'GET',
          headers: {
  ...
  render() {
    return (
      <Stack.Navigator headerMode="none">
        ...
        <Stack.Screen
          name="ListReport"
          component={this.ListReport.bind(this)}
          navigation={this.props.navigation}
        />
        <Stack.Screen
          name="ListReportPDFView"
          component={this.ListReportPDFView.bind(this)}
          navigation={this.props.navigation}
        />
      </Stack.Navigator>
    );
